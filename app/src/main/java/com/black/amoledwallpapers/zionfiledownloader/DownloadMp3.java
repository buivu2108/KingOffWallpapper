...
public final class DownloadMp3 implements DownloadFile {
    ...
    public DownloadMp3(Context context, String downloadFileUrl, String fileName) {
    ...
    public void start(final ZionDownloadListener downloadListener) {
        ...
        request.setDescription(context.getString(R.string.status_downloading_dw)).setTitle(context.getString(R.string.mp3_file_title_dw));
        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_RINGTONES, fileName);
